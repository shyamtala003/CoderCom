...
![](./screentshots/sq1.webp)
![](./screentshots/sq2.webp)
...
- <b>CSS Variables [NOTE : only for dark mode]</b>
  ...
  :root {
    ...
    --dark-gray: #dcdcdcea;
    --light-gray: #dcdcdcc5;
    --hover-light-gray: rgba(255, 255, 255, 0.1);
    --back_circle_1: radial-gradient(
      218.51% 281.09% at 100% 100%,
      rgba(253, 63, 51, 0.6) 0%,
      rgba(76, 0, 200, 0.6) 45.83%,
      rgba(76, 0, 200, 0.6) 100%
    );
    --back_circle_2: linear-gradient(
      rgb(117, 224, 230) 0%,
      rgb(57, 19, 184) 100%
    );
...
- <b>CSS Variables [Note : only for white mode]</b>
  ...
  :root {
    ...
    --bg-4: rgba(255, 255, 255, 0.2);
    --bg-5: rgba(255, 255, 255, 0.5);
    --bg-7: rgba(255, 255, 255, 0.7);
